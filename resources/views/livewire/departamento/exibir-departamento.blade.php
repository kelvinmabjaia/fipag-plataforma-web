                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-3 col-md-6 col-sm-12  ms-auto">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="text-secondary font-weight-bold ms-2">
                                    {{ number_format($departamento->processos->sum('orcamento'), 2) }}  MT 
                                </span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <span class="text-dark text-lg ms-2 font-weight-bold">
                                   {{ number_format($departamento->orcamento - $departamento->processos->sum('orcamento'), 2) }} MT
                                </span>
                            </div>
                        </div>
                ...
                <div class="card-body p-3 pt-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-9 col-sm-12">
                            ...
                            <livewire:processo.tabela-processo :departamento="$departamento->id" />
                        </div>
