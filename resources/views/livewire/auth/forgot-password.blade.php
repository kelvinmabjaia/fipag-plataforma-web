                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            ...
                            <h4 class="mb-0">{{ __('Esqueceu sua senha? Digite seu email aqui!') }}</h4>
                        </div>
                        <div class="card-body">
                            <form wire:submit.prevent="recoverPassword" action="#" method="POST" role="form text-left">
                                ...
                                <div class="card-footer pb-0 px-0">
                                    <p class="text-muted">
                                        {{ __('Lembrou da senha?') }}
                                        <a href="{{ route('login') }}"
                                            class="text-info text-dark font-weight-bold">{{ __('Acessar.') }}</a>
                                    </p>
                                </div>

                                <div class="text-center">
                                    <button type="submit"
                                        class="btn bg-gradient-dark w-100 mt-1 mb-0">{{ __('Recuperar a senha') }}</button>
                                </div>
                            </form>
