          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">aprovações pendentes</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">cabimentações pendentes</p>
                    <h5 class="font-weight-bolder mb-0">
                      12
                      {{-- <span class="text-success text-sm font-weight-bolder">+55%</span> --}}
                    </h5>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">orçamento não ulitizado</p>
                    <h5 class="font-weight-bolder mb-0">
                      MT 9.520.203,00
                      {{-- <span class="text-success text-sm font-weight-bolder">+55%</span> --}}
                    </h5>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">orçamento utilizado
                      <span class="text-dark text-sm font-weight-bolder">2022</span>
                    </p>
          ...
          <div class="card">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                ...
                <span class="font-weight-bold">4% mais</span> em 2022
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
  ...
  <script>
    ...
    */
    ...
    gradientStroke1.addColorStop(1, 'rgba(33,203,253, .2)');
    gradientStroke1.addColorStop(0.2, 'rgba(33,156,254, .1)');
    gradientStroke1.addColorStop(0, 'rgba(33,156,254, 0)'); //purple colors

    /*
      var gradientStroke2 = ctx.createLinearGradient(0, 230, 0, 50);
    
      gradientStroke2.addColorStop(1, 'rgba(246,72,57, .1)');
      gradientStroke2.addColorStop(0.2, 'rgba(246,72,57, 0)');
      gradientStroke2.addColorStop(0, 'rgba(246,72,57, 0)'); //purple colors
    */
